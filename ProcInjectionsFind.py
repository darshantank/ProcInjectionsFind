...
# ProcInjectionsFind is a Volatility plugin to detect varied types of process injections. It displays attributes for each injected memory region (VAD).

# ProcInjectionsFind allow a security analyst to get the process related information and spot any process anamoly without having to run multiple plugins.
